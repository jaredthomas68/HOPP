...
class CustomFinancialModel():
    ...
    def run_profast(self,
                    ...
                    sales_tax_rate_state=0.0625, # for texas as per Tax Foundation
                    admin_expense_percent_of_sales=0.10, # low end of typical
                    property_tax=0.0183, # TX state corporate property tax
                    property_insurance=0.005,
                    capital_gains_tax_rate=0.21, # should match federal income tax rate + state tax rate
                    debt_equity_split=72.4, # from the 2024 ATB 
                    debt_interest_rate=0.07, # from 2024 ATB
